...
class MyGraph:
    ...
    def add_scatter(self, x_values, y_values, label=None, marker=None, size=None, color=None, cmap=None, alpha=1, subtitle=None, legend=False, with_grid='both', grid_style="-", multi_index=1, twinx=False):
        multi_index = self.__add_grid_twinx(multi_index, with_grid, grid_style, twinx)
        self.objets.append(self.ax[multi_index-1].scatter(x_values, y_values, label=label, marker=marker, s=size, c=color, cmap=cmap, alpha=alpha))
