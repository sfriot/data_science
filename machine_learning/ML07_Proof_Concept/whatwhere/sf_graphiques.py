...
class MyGraph:
    ...
    def add_image(self, image_values, nb_cmap="gray", nb_vmin=None, nb_vmax=None, alpha=None, subtitle=None, multi_index=1):
        self.objets.append(self.ax[multi_index-1].imshow(image_values, cmap=nb_cmap, vmin=nb_vmin, vmax=nb_vmax, alpha=alpha))
        self.objets_desc.append("Image de l'axe {}".format(multi_index-1))
        self.ax[multi_index-1].axis("off")
        self.__add_legend_subtitle(multi_index, legend=False, subtitle=subtitle)
    ...
    def graph_confusion_matrix(self, y_true, y_pred, labels=None,
                               xticks_rotation=0, yticks_rotation=0,
                               labels_capitalize=False, normalize=None,
                               include_values=True, values_format='.0f',
                               cmap=plt.cm.Blues, cbar=True,
                               subtitle=None, multi_index=1):
        if labels is None:
    ...
    """    
    def set_axe_x(self, label=None, label_position=(0.5,0.5), tick_min=None, tick_max=None, tick_step=None, tick_labels=None, tick_labels_format=None, tick_dash=False, log_scale=False, color=None, rotation=None, ha=None, va=None, multi_index=1):
        if log_scale:
            self.ax[multi_index - 1].set_xscale('log')
    ...
    def set_axe_y(self, label=None, label_position=(0.5,0.5), tick_min=None, tick_max=None, tick_step=None, tick_labels=None, tick_labels_format=None, tick_dash=False, log_scale=False, color=None, rotation=None, ha=None, va=None, multi_index=1, twinx=False):
        if log_scale:
            self.ax[multi_index - 1].set_yscale('log')
        if label is not None:
