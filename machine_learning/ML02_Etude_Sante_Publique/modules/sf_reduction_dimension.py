...
class ACP:
    ...
    def __init__(self, df_data, n_components=None, with_reduction=True):
        ...
        self.scaler = preprocessing.StandardScaler(with_std=with_reduction).fit(self.data.values)
    ...
    """
    def graphique_choix_n(self, seuil_inertie=0.90, with_grid='y', grid_style=':', figsize=(12,8)):
        graph = sfg.MyGraph("Choix du nombre n de composantes principales", nbcol=2, nblin=1, figsize=(12,8))
